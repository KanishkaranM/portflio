  ...
  return (
    <footer className="py-6 text-center">
        <div className="flex items-center justify-center space-x-6 mb-4 md:hidden">
            <a href="#" className="text-slate hover:text-green transition-colors"><GitHubIcon/></a>
            <a href="#" className="text-slate hover:text-green transition-colors"><LinkedInIcon/></a>
            <a href="#" className="text-slate hover:text-green transition-colors"><TwitterIcon/></a>
        </div>
        <p className="font-mono text-sm text-slate">
            Designed & Built by Jane Doe
        </p>
        <a href="mailto:example@email.com" className="font-mono text-sm text-slate hover:text-green transition-colors mt-2 inline-block">
            example@email.com
        </a>
    </footer>
  );
